<div>
    <div>
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-4 xl:grid-cols-4" wfd-id="87">
            ...
            <a class="hover:shadow-lg" title="Total de clientes favoritos">
                <x-card.icon-card title="Clientes Favoritos" subtitle="{{ $favoritos }}">
                    <div
                        class="p-3 mr-4 text-yellow-500 bg-yellow-100 rounded-full dark:text-yellow-100 dark:bg-yellow-500">
                        <svg class="size-6 text-yellow-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                            fill="currentColor">
