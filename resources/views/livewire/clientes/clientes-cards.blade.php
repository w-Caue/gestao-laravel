<div>
    <div>
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-4 xl:grid-cols-4" wfd-id="87">
            ...
            <!-- Card -->
            <a class="hover:shadow-lg" title="Total de clientes que você tem acesso">
                <x-card.icon-card title="total de Clientes" subtitle="">
            ...
            <a class="hover:shadow-lg" title="Total de clientes que você tem acesso">
                <x-card.icon-card title="Novos Clientes" subtitle="">
                    <div
